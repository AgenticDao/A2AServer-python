"""OpenTelemetry Tracing Utilities for Crypto A2A Python SDK.
...
`INSTRUMENTING_MODULE_NAME` ('crypto-a2a-python-sdk') and
...
SpanKind = _SpanKind
__all__ = ['SpanKind']
INSTRUMENTING_MODULE_NAME = 'crypto-a2a-python-sdk'
INSTRUMENTING_MODULE_VERSION = '1.0.0'
