...
from crypto_a2a.utils.errors import MethodNotImplementedError
...
class A2AStarletteApplication:
    """A Starlette application implementing the Crypto A2A protocol server endpoints.
    ...
    def __init__(self, agent_card: AgentCard, http_handler: RequestHandler):
        """Initializes the Crypto A2A StarletteApplication.
    ...
    async def _handle_requests(self, request: Request) -> Response:
        """Handles incoming POST requests to the main Crypto A2A endpoint.

        Parses the request body as JSON, validates it against Crypto A2A request types,
